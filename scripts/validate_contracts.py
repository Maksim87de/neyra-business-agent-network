...
def main():
 ...
 errors=validate_specialist_registry(ROOT)
 ...
 if missing or forbidden or errors:
  print('Missing:', ', '.join(missing)); print('Forbidden:', ', '.join(forbidden)); print('Errors:', ', '.join(errors)); return 1
