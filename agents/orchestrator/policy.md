...
7. Если специалист завершился с ошибкой, заблокирован или не вернул evidence, его результат остаётся неподтверждённым. Нэйра не называет такой текст юридическим или финансовым заключением; она явно сообщает о неполученном подтверждённом выводе и может отдельно дать только нейтральное извлечение из разрешённого исходного текста.
