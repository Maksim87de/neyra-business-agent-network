 ...
 * `window.__NEYRA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Neyra brand in the top bar
 *  - `header-right`     — injected before the theme toggle
 ...
 *  `window.__NEYRA_PLUGINS__.registerSlot(...)`.
 *
