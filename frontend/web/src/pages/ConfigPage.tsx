...
import { localizeFieldLabel } from "@/i18n/dynamic-ru";
  ...
  return (
    <div className="flex flex-col gap-4">
                ...
                <CardHeader className="py-3 px-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge tone="secondary" className="text-xs">
                      Полей: {searchMatchedFields.length}
                    </Badge>
                  </div>
                </CardHeader>
      ...
      <ConfirmDialog
        ...
        description={`Будут сброшены к значениям по умолчанию поля: ${
