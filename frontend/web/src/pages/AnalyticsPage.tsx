        ...
        <Card>
          <CardContent className="py-12">
            <div className="mx-auto flex max-w-2xl flex-col gap-3 text-sm text-muted-foreground">
              ...
              <p>
                Данные о токенах, стоимости и использовании по дням на этой
                странице являются локальной отладочной оценкой. Учитываются
                только успешные ответы основного агента с блоком{" "}
                <span className="font-mono">usage</span>. Вспомогательные
                вызовы, повторные попытки и переключения провайдера, а также
                запись кеша в эту оценку не входят.
              </p>
              <p>
                При большом числе вспомогательных вызовов локальная оценка
                может быть в десятки раз ниже фактических данных провайдера,
                поэтому по умолчанию эти числа скрыты.
              </p>
              <p>
                Фактическое использование и оплату проверяйте в кабинете
                провайдера. Чтобы включить локальную отладочную оценку, задайте{" "}
