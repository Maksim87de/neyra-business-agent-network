...
export const ru: Translations = {
  ...
  status: {
    ...
    stopped: "Остановлено",
    updateNeyra: "Обновить Нэйру",
    updatingNeyra: "Обновляю Нэйру…",
  ...
  cron: {
    ...
    noJobs: "Задачи по расписанию не настроены. Создайте задачу выше.",
    last: "Последний",
    next: "Следующий",
    pause: "Пауза",
    resume: "Возобновить",
  ...
  pluginsPage: {
    ...
    headline:
      "Поиск, установка, включение и обновление плагинов Нэйры (аналог команды `neyra plugins`).",
    ...
    removeConfirm: "Удалить этот плагин из ~/.neyra/plugins/?",
    removeHint: "Удалять можно только плагины, установленные пользователем в ~/.neyra/plugins.",
  ...
  skills: {
    ...
    filters: "Фильтры",
    noSkills: "Навыки не найдены. Навыки загружаются из ~/.neyra/skills/",
    noSkillsMatch: "Нет навыков, соответствующих запросу или фильтру.",
    skillCount: "{count} навыков",
    ...
    disabledForCli: "Отключено для командной строки",
    more: "+{count} ещё",
  },

  config: {
    configPath: "~/.neyra/config.yaml",
    filters: "Фильтры",
    sections: "Разделы",
  ...
  theme: {
    title: "Режим",
    switchTheme: "Светлая/темная версия",
  },

  achievements: {
    hero: {
      kicker: "Рейтинг достижений агента",
      title: "Достижения Нэйры",
      subtitle:
        "Коллекционные значки Нэйры, полученные на основе реальной истории сессий. Известные, но ещё не полученные достижения отображаются как «Обнаруженные»; «Секретные» достижения остаются скрытыми до появления первого подходящего поведения.",
      scan_subtitle:
        "Анализ истории сессий Нэйры. Первое сканирование может занять 5–10 секунд при большой истории.",
    },
    actions: {
    ...
    stats: {
      ...
      highest_tier_hint: "Медный → Серебряный → Золотой → Бриллиантовый → Олимпийский",
      latest: "Последнее",
      latest_hint_empty: "запускайте Нэйру чаще",
      none_yet: "Пока нет",
    },
    state: {
      unlocked: "Разблокировано",
    ...
    guide: {
      ...
      secret_body:
        "Секретные достижения скрывают точное условие. Как только Нэйра обнаруживает связанный сигнал, карточка становится «Обнаруженной» и показывает требование.",
      scan_status_header: "Статус сканирования",
      scan_status_body:
        "Нэйра сканирует локальную историю один раз, затем карточки появятся автоматически. Если это занимает несколько секунд — ничего не зависло.",
    ...
    share: {
      ...
      tweet_text: "Новое достижение {tier_part}«{name}» в Нэйре ☤",
    },
  },
  kanban: {
    loading: "Загрузка доски задач…",
    loadFailed: "Не удалось загрузить доску задач: ",
    loadFailedHint:
    ...
    renderingError: "Во вкладке «Канбан» произошла ошибка отображения",
    ...
    sendNotifications: "Отправлять уведомления «завершено», «заблокировано» и «прекращено» в",
    archiveBoardConfirm:
    ...
    columnHelp: {
      triage: "Черновые идеи — уточняющий агент подготовит спецификацию",
    ...
    specifier: "уточняющий агент",
    assigneePlaceholder: "исполнитель",
    priority: "Приоритет",
    skillsPlaceholder:
      "навыки (необязательно, через запятую): например, translation, github-code-review",
    ...
    logTruncated: "(показаны последние 100 КБ — полный журнал в ",
    logAt: ")",
  },
};
