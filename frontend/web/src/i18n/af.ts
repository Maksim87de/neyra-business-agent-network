...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateNeyra: "Werk Neyra op",
    updatingNeyra: "Besig om Neyra op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Neyra-inproppe op (`neyra plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.neyra/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.neyra/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.neyra/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Versamelbare Neyra-kentekens wat verdien word uit werklike sessiegeskiedenis. Bekende, onvoltooide prestasies word as Ontdek vertoon; Geheime prestasies bly verborge totdat die eerste ooreenstemmende gedrag verskyn.",
      scan_subtitle:
        "Neyra-sessiegeskiedenis word geskandeer. Die eerste skandering kan 5–10 sekondes neem op groot geskiedenisse.",
    },
    actions: {
      rescan: "Herskandeer",
    },
    stats: {
      ...
      latest: "Jongste",
      latest_hint_empty: "gebruik Neyra meer",
      none_yet: "Nog geen",
    },
    state: {
      unlocked: "Ontsluit",
    ...
    guide: {
      ...
      secret_body:
        "Geheime hou hul presiese sneller verborge. Sodra Neyra 'n verwante sein sien, word die kaart Ontdek en wys sy vereiste.",
      scan_status_header: "Skanderingstatus",
      scan_status_body:
        "Neyra skandeer plaaslike geskiedenis een keer, daarna verskyn kaarte outomaties. Niks is vasgevang as dit 'n paar sekondes neem nie.",
