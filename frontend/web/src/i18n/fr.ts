...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateNeyra: "Mettre à jour Neyra",
    updatingNeyra: "Mise à jour de Neyra…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Neyra (parité avec `neyra plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.neyra/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.neyra/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.neyra/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "Neyra Achievements",
      subtitle:
        "Badges Neyra à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Neyra en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Neyra davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Neyra détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Neyra analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Neyra ☤",
    },
  },
  kanban: {
