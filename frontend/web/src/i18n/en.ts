...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateNeyra: "Update Neyra",
    updatingNeyra: "Updating Neyra…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Neyra plugins (`neyra plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.neyra/plugins/?",
    removeHint: "Only user-installed plugins under ~/.neyra/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.neyra/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Neyra badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Neyra session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Neyra more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Neyra sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Neyra is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
